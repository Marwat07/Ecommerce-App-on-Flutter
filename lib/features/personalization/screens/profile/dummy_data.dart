...
/// -- List of all Products
  static final List<ProductModel> products = [
    ProductModel(
      ...
      price: 700,
      isFeatured: true,
      thumbnail: TImages.pd,
      description: 'Mac Book Air M2',
      brand: BrandModel(id: '1', image: TImages.apple, name: 'Apple', productsCount: 265, isFeatured: true),
      images: [TImages.pd1, TImages.pd2, TImages.pd3, TImages.pd5],
      salePrice: 500,
      categoryId: '1',
      productAttributes: [
        ProductAttributeModel(name: 'Color', values: ['Gray', 'Black', 'White']),
        ProductAttributeModel(name: 'Size', values: ['12 inch', '15 inch', '20 inch']),
      ],
      productVariations: [
      ...
      productTypes: 'ProductType.variable',
    ),
  ];
}
  //   ProductModel(
